...
class Scanner:
    ...
    regex = {
        ...
        'keyword': r'(?<!\w)(int|fun|char|long|var|short|print|float|double|void|if|else|for|while|do|break|continue|struct|switch|case|default|return|main|printf|scanf|elif|auto|enum|extern|goto|register|signed|sizeof|static|typedef|union|unsigned|volatile|while)(?!\w)',
