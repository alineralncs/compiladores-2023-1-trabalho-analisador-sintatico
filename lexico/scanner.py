...
class Scanner:
    ...
    regex = {
        ...
        'keyword': r'(?<!\w)(int|or|and|fun|char|long|var|short|print|float|double|true|false|void|if|else|for|while|do|break|continue|struct|switch|case|default|return|main|printf|scanf|elif|auto|enum|extern|goto|register|signed|sizeof|static|typedef|union|unsigned|volatile|while)(?!\w)',
